    ...
    return Positioned(
      ...
      child: GestureDetector(
        onPanStart: (dragStartDetails) {
          ...
          if (box != null) {
            var local = box.globalToLocal(dragStartDetails.globalPosition);

            _isLeft = local.dx < box.size.width / 2;
            _isTop = local.dy < box.size.height / 2;
        ...
        child: Transform.rotate(
          ...
          child: Container(
            constraints: constraints,
            child:
                widget.children[index].builder(_currentItemPosition, _progress),
          ),
        ),
      ),
    );
...
extension SwiperPositionEx on SwiperPosition {
  bool get isNone => this == SwiperPosition.none;

  bool get isRight => this == SwiperPosition.right;

  bool get isLeft => this == SwiperPosition.left;
}
